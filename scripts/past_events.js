...
const pastEvents = data.events.filter(cont => cont.date < data.currentDate)
...
function showCards(array) {
    ...
    pastCards.innerHTML = insertFilterCards
}
function noResults(){
    pastCards.innerHTML = `<div class="searchFailed">
...
filterCards = pastEvents.filter(cont => filterCategories.includes(cont.category))
